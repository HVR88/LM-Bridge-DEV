...
PROVIDER_CAPABILITIES: Dict[str, Dict[str, Any]] = {
    ...
    "cover_art_archive": {
        ...
        "lock_status": "soft",
        "lock_warning": "Disabling Cover Art Archive will prevent new album artwork downloads. Continue?",
        "auth": {"type": "none", "fields": []},
    ...
    "theaudiodb": {
        ...
        "endpoints": {
            "base_url": "https://www.theaudiodb.com/api/v2/json",
            "docs_url": "",
        },
    ...
    "wikipedia": {
        ...
        "lock_status": "soft",
        "lock_warning": "Disabling Wikipedia will prevent new artist summary downloads. Continue?",
        "auth": {"type": "none", "fields": []},
    ...
    "plex": {
        ...
        "endpoints": {
            ...
            "docs_url": "https://support.plex.tv/articles/201638786-plex-media-server-url-commands/",
        },
